...
// Início, Agenda, Pacientes e Novo atendimento já ficam na barra fixa do
// celular (BottomNav) — aqui mora só o resto, pra não duplicar atalho.
const ITENS = [
  ...
  return (
    <div className="sheet" role="dialog" aria-modal="true" aria-label="Mais opções">
      ...
      <div className="sheet__painel mais-menu" ref={painelRef}>
        ...
        <h2 className="sheet__titulo">Mais</h2>
